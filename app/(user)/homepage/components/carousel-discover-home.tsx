...
const CarouselContent = styled.div<{ background: string }>`
        ...
        <CarouselContainer className="w-full cursor-pointer border">
          <Link href="#!">
            <img
              ...
              alt={item.title}
            />
            <CarouselContent background={item.backgroundContent} className="h-[360px] sm:h-[300px] xl:h-[350px] lg:h-[400px] p-[30px] flex flex-col justify-between flex-1">
